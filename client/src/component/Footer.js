      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-[#a7ead0] via-[#dff8ee] to-[#a7ead0] rounded-lg shadow-md py-8 px-4 md:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Grid layout */}
            <div className=" ">
              <div className="bg-white  text-black rounded-2xl shadow-2xl  shadow-red-500 p-8 max-w-md mx-auto">
            ...
            <div className="text-center text-black grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
              {/* Corporate Office */}
              <div className="bg-gradient-to-br from-indigo-100 to-indigo-300 border shadow-2xl shadow-gray-500 border-indigo-400 shadow-lg rounded-lg p-6">
                <div className="flex flex-col items-center">
              ...
              {/* Branch Office */}
              <div className="bg-gradient-to-br from-teal-100 to-teal-300 border border-teal-400 shadow-2xl shadow-blue-500 rounded-lg p-6">
                <div className="flex flex-col items-center">
