      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-2/3">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            At VRS Manpower Solutions , we believe that teamwork is the cornerstone of our success. We take great pride in fostering a collaborative environment where every employee feels valued and empowered to contribute their best.
          </p>
